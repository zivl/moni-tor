...
let smsClient = require('twilio')(
	'ACd787fd89ceb7d642dd3b739cb72f935c',
	'31d6775f34be5b66790c87687efa4270'
);

let sendNotification = require('./fireBase/notification.js');
...
let numberOfMonitors = 5;
//let notificationTimeoutInMinutes = 5;
...
app.get('/testInitData', function (request, response) {
	for (let i = 0; i < (numberOfMonitors + 2); i++) {
		requestMonitor({
			id: '3300876' + i + i + i,
